...
STICKY_BROADCAST = (
    ...
    "provide no security (anyone can access them), no protection (anyone can modify them), and many other problems. "
...
class SendBroadcastReceiverPermission(CoroutinePlugin, ManifestPlugin):
    ...
    def _check_method_invocation(self, method_invocation, imports):
        """
        Checks the type of method being called, the number of arguments, and adds it to the issues list if it
