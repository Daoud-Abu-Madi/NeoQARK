...
ALLOW_ALL_HOSTNAME_VERIFIER_DESC = ("This can allow for improper x.509 certificate validation wherein the DNS "
                                    ...
                                    "CA, regardless of the domain it was issued for. This can be validated using the "
